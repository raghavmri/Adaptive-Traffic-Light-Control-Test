...
cwd = os.getcwd()
camera1 = cv2.VideoCapture(os.path.join(cwd, "video1.avi"))
camera2 = cv2.VideoCapture(os.path.join(cwd, "video2.avi"))
camera3 = cv2.VideoCapture(os.path.join(cwd, "video3.avi"))
camera4 = cv2.VideoCapture(os.path.join(cwd, "video4.avi"))

car_cascade = cv2.CascadeClassifier(os.path.join(cwd, 'cars.xml'))
